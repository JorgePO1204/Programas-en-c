...
void mostrarDatos() {
    ...
    do {
        ...
        switch(opcion) {
            case 1:
                agregarEmpleado(empleados, &N);
                break;
            case 2:
                mostrarInformacionSueldos(empleados, N);
                break;
            case 3:
                buscarEmpleadoPorNombre(empleados, N);
                break;
            case 4:
                buscarEmpleadosPorPuestoNombre(empleados, N);
                break;
            case 5:
                modificarEmpleadoPorNombre(empleados, N);
                break;
            case 6:
                mostrarTodosEmpleados(empleados, N);
                break;
            case 7:
                darDeBajaEmpleadoPorNombre(empleados, &N);
                break;
            case 8:
